...
const product={product_id:"prd-soldout",product_name:"품절 상품",unit_price:1000,stock_limit:1,reserved_quantity:1,available_quantity:0,active:true,display_order:1,purchase_method:"fixed_price" as const,reserve_price:0,minimum_offer_price:0,maximum_offer_price:0,buy_now_price:0,bid_increment:0,bid_input_mode:"direct_amount" as const,auction_extension_window_seconds:0,auction_extension_seconds:0,auction_max_extensions:0,auction_extension_count:0,sale_starts_at:"",sale_ends_at:"",purchase_flow:"checkout" as const,sku:"SKU",category_major:"",category_minor:"",category_detail:"",expected_arrival_date:"",arrival_date:"",inventory_status:"unscheduled" as const,catalog:null,listing:null,inventory:[]};
describe("상품 카드",()=>{
