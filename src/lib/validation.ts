...
export const buyerSchema = z.object({
  ...
  address_province: z.string().min(1, "도/광역시/특별시를 선택해 주세요."),
  address_city: z.string().min(1, "시/군/구를 선택해 주세요."),
  address_street: z.string().trim().min(1, "도로명/지번을 입력해 주세요."),
  address_building: z.string().trim().optional(),
  address_detail: z.string().trim().min(1, "상세주소를 입력해 주세요."),
