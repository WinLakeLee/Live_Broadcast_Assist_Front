...
export const createOrder = (input: { buyer_name: string; phone: string; address: string; stock_policy: StockPolicy; quoted_amount: number; captcha_token: string; items: OrderItem[] }, ticket: TicketCredentials, signal?: AbortSignal) =>
